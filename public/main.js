...
/* harmony export */ });
/* harmony import */ var _gameStates__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../gameStates */ "./src/js/gameStates.js");
/* harmony import */ var _Player__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Player */ "./src/js/classes/Player.js");
/* harmony import */ var _functions_createEnemies__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../functions/createEnemies */ "./src/js/functions/createEnemies.js");
/* harmony import */ var _functions_mainLoop__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../functions/mainLoop */ "./src/js/functions/mainLoop.js");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
/* harmony export */ });
/* harmony import */ var _gameStates__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../gameStates */ "./src/js/gameStates.js");
/* harmony import */ var _ui_drawGameOverMenu__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../ui/drawGameOverMenu */ "./src/js/ui/drawGameOverMenu.js");
function _createForOfIteratorHelper(o, allowArrayLike) { var it = typeof Symbol !== "undefined" && o[Symbol.iterator] || o["@@iterator"]; if (!it) { if (Array.isArray(o) || (it = _unsupportedIterableToArray(o)) || allowArrayLike && o && typeof o.length === "number") { if (it) o = it; var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e) { throw _e; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var normalCompletion = true, didErr = false, err; return { s: function s() { it = it.call(o); }, n: function n() { var step = it.next(); normalCompletion = step.done; return step; }, e: function e(_e2) { didErr = true; err = _e2; }, f: function f() { try { if (!normalCompletion && it["return"] != null) it["return"](); } finally { if (didErr) throw err; } } }; }
...
function mainLoop(game, currentTime) {
  ...
  if (game.gameState === _gameStates__WEBPACK_IMPORTED_MODULE_0__.gameStates.MENU) {
    var canvasDisplay = game.canvas.style.getPropertyValue('display');
    var mainMenuDisplay = mainMenu.style.getPropertyValue('display');
  ...
  if (game.gameState === _gameStates__WEBPACK_IMPORTED_MODULE_0__.gameStates.OVER) {
    ...
    var _canvasDisplay = game.canvas.style.getPropertyValue('display');

    var gameOverMenuDisplay = gameOverMenu.style.getPropertyValue('display');
  ...
  if (game.gameState === _gameStates__WEBPACK_IMPORTED_MODULE_0__.gameStates.RUNNING) {
    var _canvasDisplay2 = game.canvas.style.getPropertyValue('display');

    var _mainMenuDisplay = mainMenu.style.getPropertyValue('display');

    var _gameOverMenuDisplay = gameOverMenu.style.getPropertyValue('display');
...
/* harmony import */ var _classes_GameLoop__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./classes/GameLoop */ "./src/js/classes/GameLoop.js");
...
var game = new _classes_GameLoop__WEBPACK_IMPORTED_MODULE_2__.GameLoop({
  window: window,
  canvas: canvas
});
game.start();
